...
## Mulige refaktoreringer (duplisert kode)

Kandidater som kan trekkes ut til felles modul:

- `slug(value: string)` finnes i alle steg (`00`, `01`, `02`, `03`).
- `Aktor`-interface er gjentatt i flere filer med samme felt.
- Web-søk-tool-konfig (`type: web_search_20250305`, `name`, `user_location`) er duplisert i steg 00 og 01.
- Små filhjelpere (`lesJsonFil`, fil-eksistens/sjekk, mappe-opprettelse) er delvis overlappende på tvers av stegene.
